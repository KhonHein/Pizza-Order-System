                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('category#update') }}" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="categoryName" type="text" value="{{ old('categoryName',$category->category_name) }}" class="form-control @error('categoryName') is-invalid @enderror " aria-required="true" aria-invalid="false">
                                @error('categoryName')
